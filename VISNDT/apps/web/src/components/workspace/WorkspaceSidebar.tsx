...
const NAV_CONFIG: Record<NavigableWorkspaceRole, NavItem[]> = {
  BUYER: [
    ...
    { label: '我的评估', href: '/workspace/evaluations', icon: 'check' },
  ...
  SUPPLIER: [
    ...
    { label: '我的产品', href: '/workspace/supplier/products', icon: 'inbox' },
    { label: '企业资料', href: '/workspace/supplier/profile', icon: 'building' },
    { label: '组织成员', href: '/workspace/supplier/members', icon: 'users' },
    { label: '通知中心', href: '/workspace/notifications', icon: 'bell' },
