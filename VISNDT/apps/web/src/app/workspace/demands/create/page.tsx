...
function DemandCreateContent() {
  ...
  const validate = (): boolean => {
    ...
    if (form.quantity && Number(form.quantity) <= 0) {
      errs.quantity = 'Quantity must be positive';
    }
    setErrors(errs);
      ...
      <div className="flex-1 flex flex-col min-w-0">
        ...
        <div className="flex-1 bg-slate-50 p-6">
          <div className="max-w-2xl mx-auto space-y-6">
            <div>
              <h2 className="text-xl font-bold text-slate-900">Create Demand</h2>
              <p className="text-slate-500 text-sm mt-1">
                Describe your inspection equipment requirements.
              </p>
            </div>
            ...
            >
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. Need 100 industrial endoscopes"
