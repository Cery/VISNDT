// ============================================
// M21.4.2 Embedding Data Population Script (Product + Chunks Only)
// ============================================
...
const OPENAI_API_KEY = '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';
const OPENAI_BASE_URL = 'https://openrouter.ai/api/v1/embeddings';
...
async function generateContentChunks() {
  ...
  for (const c of contents) {
    try {
      ...
      if (chunks.length === 0) {
        console.log(`  [SKIP] Content ${c.id.slice(0, 8)}... : no paragraphs`);
        continue;
      }
...
async function main() {
  console.log('=== VISNDT M21.4.2 Product + Chunks ===');
